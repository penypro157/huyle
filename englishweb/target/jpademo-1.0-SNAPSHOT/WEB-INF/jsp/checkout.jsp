...
<body>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="../../resources/index.jsp"><span>E</span>-Shop</a>
						</div>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="/checkout/checkoutpage" class="active"><i class="fa fa-crosshairs"></i> Checkout</a></li>
				...
				<div class="row">
					...
					<div class="col-sm-5 clearfix">
						<div class="bill-to">
							<p>Bill To</p>
							<div class="form-one">
								<form:form action="/checkoutpage" method="POST" modelAttribute="order" id="buy">

									<form:input type="text" placeholder="fullName" path="fullName"/>
									<form:input type="text" placeholder="address" path="address"/>
									<form:input type="text" placeholder="phone" path="phone"/>
									<form:input type="text" placeholder="note" path="note"/>
									<form:input type="text" placeholder="totalPrice" path="totalPrice"/>
					...
					<tbody>
						...
						<tr>
							<td class="cart_product">
								<a href=""><img src="/resources/images/shop/${cart.product.photo}" alt=""></a>
							</td>
							...
							<td class="cart_quantity">
								<div class="cart_quantity_button">
									...
									<input class="cart_quantity_input" type="text" name="quantity" value="${cart.product.price}" autocomplete="off" size="2">
									<a class="cart_quantity_down" href=""> - </a>
								</div>
							</td>
							<td class="cart_total">
								<p class="cart_total_price"><c:out value="${cart.product.price*cart.quantity}"></c:out></p>
							</td>
	...
	<script src="/resources/js/js-checkout.js"></script>
</body>
</html>