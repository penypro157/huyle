...
<head>
    ...
    <link href="../../resources/css/add-cart-effect.css" rel="stylesheet">
    <!--[if lt IE 9]>
...
<body>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="/home/index"><span>H</span> Lee</a>
						</div>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="/checkoutpage"><i class="fa fa-crosshairs"></i> Checkout</a></li>
								<li><a href="/viewcart"><i class="fa fa-shopping-cart"></i> Cart</a></li>
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="../WEB-INF/jsp/shop.html">Products</a></li>
										<li><a href="../WEB-INF/jsp/product-details.html">Product Details</a></li>
										<li><a href="../WEB-INF/jsp/checkout.html">Checkout</a></li>
										<li><a href="../WEB-INF/jsp/cart.html">Cart</a></li>
										<li><a href="../WEB-INF/jsp/login.html">Login</a></li>
                                    </ul>
                                </li>
								<li class="dropdown"><a href="#">Blog<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="/blog">Blog List</a></li>
										<li><a href="/admin">Blog Single</a></li>
                                    </ul>
                                </li>
								<li><a href="../WEB-INF/jsp/404.html">404</a></li>
								<li><a href="../WEB-INF/jsp/contact-us.html">Contact</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-3">
							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											<img src="/resources/images/shop/${product.photo}" alt="" />
											<h2>${product.price}</h2>
											<p>${product.name}</p>
										...
										<div class="product-overlay">
											<div class="overlay-content">
												<h2>${product.price}</h2>
												<p>${product.name}</p>
												<a onclick="test(${product.id})"  class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
											</div>
										</div>
    ...
    <script src="/resources/js/add-cart-effect.js"></script>
