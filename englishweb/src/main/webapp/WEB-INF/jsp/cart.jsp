				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="/home/index"><span>E</span>-Shop</a>
						</div>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="/checkout/checkoutpage"><i class="fa fa-crosshairs"></i> Checkout</a></li>
						...
						<tr>
							...
							<td class="cart_quantity">
								<div class="cart_quantity_button">
									...
									<input class="cart_quantity_input" type="text" name="quantity" value="${cart.quantity	}" autocomplete="on" size="2">
				...
				<div class="col-sm-6">
					<div class="total_area">
						<ul>
							...
							<a class="btn btn-default check_out" href="/checkoutpage">Check Out</a>
					</div>
				</div>
			</div>
		</div>
